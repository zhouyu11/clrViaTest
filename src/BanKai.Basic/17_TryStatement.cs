...
namespace BanKai.Basic
{
    ...
    public class TryStatement
    {
        ...
        public void should_run_finally_block_anyway()
        {
            ...
            // change the variable value to fix the test.            
            string expectedTracingMessage = "try block executed." + Environment.NewLine + "FormatException catched." +Environment.NewLine+ "finally blocked executed." + Environment.NewLine;
